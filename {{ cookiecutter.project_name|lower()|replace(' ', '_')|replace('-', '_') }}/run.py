...
from {{ cookiecutter.project_name|lower()|replace(' ', '_')|replace('-', '_') }} import download as kg_download
from {{ cookiecutter.project_name|lower()|replace(' ', '_')|replace('-', '_') }}.merge_utils.merge_kg import load_and_merge
from {{ cookiecutter.project_name|lower()|replace(' ', '_')|replace('-', '_') }}.query import parse_query_yaml, result_dict_to_tsv, run_query
from {{ cookiecutter.project_name|lower()|replace(' ', '_')|replace('-', '_') }}.transform import DATA_SOURCES
from {{ cookiecutter.project_name|lower()|replace(' ', '_')|replace('-', '_') }}.transform import transform as kg_transform
